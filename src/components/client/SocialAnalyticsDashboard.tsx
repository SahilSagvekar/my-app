...
export function SocialAnalyticsDashboard({ clientId }: { clientId: string }) {
      ...
      <Dialog open={showConnectDialog} onOpenChange={setShowConnectDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Choose a platform to connect and track your analytics
            </DialogDescription>
          </DialogHeader>
            ...
            {PLATFORMS.map((platform) => {
              ...
              return (
                <button
                  ...
                  className="w-full flex items-center gap-3 p-4 rounded-lg border hover:bg-muted/50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <div

      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-black/60 max-w-2xl mx-auto">
            Premium entertainment produced by E8 Productions. Watch what happens when creativity meets innovation.
          </p>
        </div>
          ...
          {shows.map((show, index) => (
            ...
            >
              ...
              <div className="relative aspect-[16/9] overflow-hidden bg-black/5">
                <Image src={show.image} alt={show.title} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                {/* Play Button Overlay */}
              ...
              <div className="p-8">
                ...
                <button className="group/btn inline-flex items-center gap-2 text-black transition-all hover:gap-3">
                  Watch Now

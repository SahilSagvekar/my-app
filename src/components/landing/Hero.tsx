        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center justify-center min-h-[20vh] sm:min-h-[25vh] py-8 sm:py-10 bg-[#ff2828] rounded-2xl sm:rounded-3xl shadow-2xl relative transition-all duration-300 hover:scale-[1.02]" style={{ boxShadow: 'inset 0 -20px 40px rgba(0,0,0,0.15), inset 0 20px 40px rgba(255,255,255,0.1), 0 10px 30px rgba(0,0,0,0.3)' }} onMouseEnter={(e) => e.currentTarget.style.boxShadow = 'inset 0 -20px 40px rgba(0,0,0,0.2), inset 0 20px 40px rgba(255,255,255,0.15), 0 20px 50px rgba(0,0,0,0.5)'} onMouseLeave={(e) => e.currentTarget.style.boxShadow = 'inset 0 -20px 40px rgba(0,0,0,0.15), inset 0 20px 40px rgba(255,255,255,0.1), 0 10px 30px rgba(0,0,0,0.3)'}>
            <div className="flex items-center gap-2 sm:gap-3 mb-2 px-4 sm:px-0">
              ...
              <Eye className="w-5 h-5 sm:w-7 sm:h-7 text-white" style={{ filter: 'drop-shadow(0 4px 8px rgba(0,0,0,0.5))' }} />
              <span className="font-mono text-5xl sm:text-6xl lg:text-7xl font-bold text-white tracking-tight" style={{ textShadow: '0 4px 12px rgba(0,0,0,0.6)' }} suppressHydrationWarning>{views.toLocaleString()}</span>
            </div>
            <p className="text-black text-lg sm:text-base lg:text-lg font-bold px-4 sm:px-0">views generated for clients</p>
          </div>
        </div>
      </div>
    </section>

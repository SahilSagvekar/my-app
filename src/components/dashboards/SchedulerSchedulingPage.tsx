...
interface ScheduledPost {
  ...
  taskId?: string;
  contentTitle: string;
  platform: 'instagram' | 'facebook' | 'twitter' | 'tiktok' | 'youtube' | 'linkedin' | 'snapchat';
...
export function SchedulerSchedulingPage() {
  ...
  const platformCounts = {
    ...
    snapchat: scheduledPosts.filter(p => p.platform === 'snapchat').length,
  };

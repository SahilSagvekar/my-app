...
const initialModules: Module[] = [
  {
    ...
    description:
      "Learn the fundamentals of quality control and your role in the production workflow",
    duration: "12 min",
    completed: false,
    unlocked: true,
    content: [
    ...
    quiz: [
      {
        ...
        correctAnswer: 0,
        explanation:
          "FIFO means First In, First Out - tasks are reviewed in the order they were submitted to ensure fairness.",
      },
      {
        id: 2,
        ...
        options: [
          "Only to Client",
          "Only to Scheduler",
          "Editor, Client, or Scheduler",
          "Only back to Editor",
        ],
        correctAnswer: 2,
        explanation:
          "Approved tasks can be routed to Client Review, Scheduler, or back to Editor for revisions depending on the workflow.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "1920x1080 (1080p) is the minimum resolution standard for video deliverables.",
      },
      {
        id: 2,
        ...
        correctAnswer: 1,
        explanation:
          "Voice-over should peak between -6dB and -3dB for optimal clarity without distortion.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "E8 Productions uses an 8px base grid system for all designs to ensure consistency and alignment.",
      },
      {
        id: 2,
        ...
        correctAnswer: 2,
        explanation:
          "300 dpi is the minimum resolution for print graphics to ensure quality reproduction.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "Actionable feedback is specific, explains what needs to change, provides context, and ideally offers guidance on how to fix it.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "The QC Review Queue uses FIFO ordering - tasks are sorted by submission time with the oldest tasks appearing first.",
      },
    ],
  },
];
...
const finalQuiz: QuizQuestion[] = [
  {
    ...
    correctAnswer: 1,
    explanation:
      "QC Reviewers ensure all content meets E8 Productions quality standards before moving forward in the workflow.",
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      "Reject submissions only when there are critical issues that violate brand standards, technical requirements, or deliverable specifications.",
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      "When rejecting, always provide clear, specific, and actionable feedback so the editor knows exactly what to fix.",
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      "Tasks marked for client review are automatically routed to the client after QC approval.",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      "1920x1080 (1080p) is the minimum resolution standard for all video deliverables.",
  },
];

interface QCTrainingPageProps {
  currentRole?: string;
}
  ...
  const handleSubmitFinalQuiz = () => {
    ...
    if (passed) {
      ...
      toast("🎉 Congratulations!", {
        description: "You are now a Certified QC Reviewer!",
      });
    } else {
      toast("📚 Keep Learning", {
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Answer all questions correctly to earn your QC Reviewer
          ...
          <Card className="bg-gradient-to-br from-yellow-50 to-yellow-100 border-yellow-300">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-yellow-800 mb-4">
                You are now a Certified QC Reviewer at E8 Productions
              </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm">
              ...
              <ul className="text-muted-foreground space-y-1">
                ...
                <li>
                  • Complete the final certification exam with 80% or higher
                </li>
                <li>
                  • Once certified, you'll have full access to all training
                  materials
                </li>
              </ul>
            </div>

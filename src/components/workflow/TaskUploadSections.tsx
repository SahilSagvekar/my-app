...
export function TaskUploadSections({
  ...
  return (
    <div className="space-y-3">
      ...
      {sections.length > 1 && (
        <Alert
          variant={allRequiredFilesUploaded() ? "default" : "destructive"}
        >
          {allRequiredFilesUploaded() ? (
            ...
            <>
              ...
              <AlertDescription className="text-sm">
                Please upload all required files (marked with *) before submitting to QC.
              </AlertDescription>
            </>
          )}
        </Alert>
            ...
            <div className="flex items-start gap-3 mb-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  {section.required ? "Required" : "Optional"} • Upload to{" "}
                  <code className="bg-gray-100 px-1 py-0.5 rounded text-xs">
                    {task.title}/
                    {section.folderType === "main" ? "" : `${section.folderType}/`}
                  </code>
                </p>
              </div>
            </div>

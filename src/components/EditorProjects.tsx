...
const projects = [
  {
    ...
    description:
      "Complete holiday marketing campaign including video ads, social media content, and email templates.",
  ...
  },
  {
    ...
    description:
      "Updated brand guidelines with new color palette, typography, and logo variations.",
  ...
  },
  {
    ...
    description:
      "Comprehensive social media campaign for Q4 including Instagram, TikTok, and YouTube content.",
  ...
  },
  {
    ...
    description:
      "Complete set of web assets for healthcare company website redesign.",
  ...
  },
  {
    ...
    description:
      "Product launch video series including explainer videos and testimonials.",
  ...
  },
  {
    ...
    description:
      "Complete annual report design with infographics and data visualizations.",
    lastActivity: "2 days ago",
    team: [{ name: "Tom B.", avatar: "TB" }],
  },
];
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
        <Card>
          <CardContent className="p-4 sm:p-6 text-center">
            <FolderOpen className="h-6 w-6 sm:h-8 sm:w-8 mx-auto mb-2 text-blue-600" />
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-2xl font-medium">
              {projects.reduce((acc, p) => acc + p.myTasks, 0)}
            </h3>
              ...
              {project.myTasks > 0 && (
                <div className="bg-blue-50 rounded-lg p-2 text-center">
                  <span className="text-sm text-blue-700">
                    {project.myTasks} task{project.myTasks === 1 ? "" : "s"}{" "}
                    assigned to me
                  </span>
                </div>
              )}

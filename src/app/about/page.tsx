    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-20 sm:pt-24 pb-16 sm:pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 mb-12 sm:mb-20 px-4 sm:px-0">
            {values.map((value, index) => (
              <div key={index} className="text-center">
                ...
                <h3 className="text-base sm:text-lg text-black mb-2 sm:mb-3">
                  {value.title}
                </h3>
          ...
          <div className="bg-black/[0.02] rounded-2xl sm:rounded-3xl p-6 sm:p-12 text-center px-4 sm:px-6">
          ...
          <div className="mt-12 sm:mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12 px-4 sm:px-0">
              {positions.map((position, index) => (
                <div
                  key={index}
                  className="bg-white border border-black/5 rounded-xl sm:rounded-2xl p-4 sm:p-6 transition-all hover:border-black/20 hover:shadow-lg"
                >
                  <div className="flex items-start justify-between mb-3 sm:mb-4">
                    <h3 className="text-base sm:text-lg text-black">
                      {position.title}
                    </h3>
                  </div>
                  <div className="flex items-center gap-2 mb-3 sm:mb-4 flex-wrap">
                    <span className="px-2.5 sm:px-3 py-1 bg-black/5 rounded-full text-xs text-black/70">
                      {position.type}
                    </span>
                    <span className="px-2.5 sm:px-3 py-1 bg-black/5 rounded-full text-xs text-black/70">
                      {position.location}
                  ...
                  <p className="text-black/60 text-xs sm:text-sm mb-4 sm:mb-6">
                    {position.description}
                  </p>
                  <button className="group inline-flex items-center gap-2 text-black text-xs sm:text-sm transition-all hover:gap-3">
                    Learn More
            ...
            <div className="text-center bg-black rounded-2xl sm:rounded-3xl p-6 sm:p-8 mx-4 sm:mx-0">
              <h3 className="text-base sm:text-lg text-white mb-2 sm:mb-3">
                Don't see a perfect fit?
              </h3>
              <p className="text-sm sm:text-base text-white/70 mb-4 sm:mb-6 max-w-xl mx-auto">
              ...
              <button className="px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base bg-white text-black rounded-full transition-all hover:bg-white/90 hover:scale-105 w-full sm:w-auto">
                Send Your Resume
              </button>
            </div>
          </div>

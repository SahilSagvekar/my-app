    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8 sm:gap-10 lg:gap-12">
            ...
            <div className="flex-1 order-1 md:order-2 w-full md:w-auto px-4 sm:px-0">
              <h2 className="text-2xl sm:text-3xl lg:text-3xl text-black mb-3 sm:mb-4 text-center md:text-left">What We Do</h2>
              <p className="text-base sm:text-base text-black/60 mb-4 sm:mb-6 text-center md:text-left">
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8 max-w-xs mx-auto md:max-w-none md:mx-0">
                <div>
                  ...
                  <div className="text-black/50 text-sm sm:text-sm">Complete Solutions</div>
                </div>
                <div>
                  <div className="text-base sm:text-lg text-black mb-1 font-semibold">End-to-End</div>
                  <div className="text-black/50 text-sm sm:text-sm">Full Production</div>
                </div>
              </div>

              <Link
                href="/services"
                className="inline-flex items-center gap-2 px-6 sm:px-6 py-3.5 sm:py-3 text-base sm:text-base bg-black text-white rounded-full hover:bg-black/90 active:scale-95 transition-all group w-full sm:w-auto justify-center md:justify-start font-medium shadow-lg shadow-black/10"
              >
                View All Services
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8 sm:gap-10 lg:gap-12">
            ...
            <div className="flex-1 order-1 md:order-2 w-full md:w-auto px-4 sm:px-0">
              ...
              <Link
                href="/shows"
                className="inline-flex items-center gap-2 px-5 py-3 text-base sm:text-base text-black hover:gap-3 active:scale-95 transition-all group mx-auto md:mx-0 block w-fit font-medium"
              >
                Explore Our Shows
                <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
              </Link>
      ...
      <section className="py-16 sm:py-16 px-5 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-base text-black/60 mb-6 sm:mb-8 px-4 sm:px-0">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-4 px-4 sm:px-0">
            <Link
              href="/about"
              className="inline-flex items-center gap-2 px-6 sm:px-6 py-3.5 sm:py-3 text-base sm:text-base bg-white text-black border-2 border-black/10 rounded-full hover:border-black/30 hover:shadow-lg active:scale-95 transition-all group w-full sm:w-auto justify-center font-medium"
            >
              Learn About Us
              <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
            </Link>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-6 sm:px-6 py-3.5 sm:py-3 text-base sm:text-base bg-black text-white rounded-full hover:bg-black/90 active:scale-95 transition-all group w-full sm:w-auto justify-center font-medium shadow-lg shadow-black/10"
            >
              Get in Touch
              <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
            </Link>

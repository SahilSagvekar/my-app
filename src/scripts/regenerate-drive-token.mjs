// scripts/regenerate-drive-token.mjs
//
...
//
// NOTE: this file uses ES module `import` syntax, so it needs the .mjs
// extension — e8-file-server's package.json has "type": "commonjs", so a
// plain .js file here would fail with a SyntaxError on `import`.
//
...
// USAGE:
//   1. cd e8-file-server
//   2. node scripts/regenerate-drive-token.mjs

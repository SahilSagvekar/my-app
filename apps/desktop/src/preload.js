...
// desktop app. It exposes exactly three things under window.e8 — the
// website checks `window.e8?.isDesktopApp` to know it's running inside
// the desktop shell (vs. a normal browser tab) and behaves accordingly.
